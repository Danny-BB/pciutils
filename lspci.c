...
static int opt_diagnose;		/* Enable diagnostic mode for PCIe health checks */
...
"--diagnose\tEnable PCIe diagnostic mode (check for common configuration issues)\n"
"\n"
"PCI access options:\n"
GENERIC_HELP
;
...
#endif
      default:
	if (!strcmp(argv[optind-1], "--diagnose")) {
	  opt_diagnose = 1;
	  need_topology = 1;
	  break;
	}
